...
let CommonService = class CommonService {
    constructor(toast, menu) {
        this.toast = toast;
        this.menu = menu;
        this.showErrorMessage = (msg) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
        ...
        this.showSuccessMessage = (msg) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const toast = yield this.toast.create({
                message: msg,
                duration: 2000,
                color: 'success'
